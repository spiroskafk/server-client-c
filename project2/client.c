...
int main( void )
{
	...
	/* Alarm. Kathe 10 deutera tipwnetai to minima signwmis ston pelati mexri na mpeis to critical section 		tou semaphorou tilefwniti. Otan o client sundethei me ton tilefwniti stelnetai to write apo ton server 		kai diavazetai apo to read ston client. Epeita to alarm ginetai 0, opote to minima stamataei na         	stelnetai */
	alarm(10);
	...
	/* Print */
	printf( "You wanna reserve %d positions\n", positions );
	printf( "In %c 'ZONE' \n", zone );
	printf( "===================================================\n" );
...
/* Diavazei to eidos minimatos apo ton server kai to ektipwnei ston client */     
...
{  
	...
	/* Diavazete to eidos tou minimatos apo ton server kai oi pinakes - zones */
    ...
    /* Analoga me to eidos tou minimatos ektipwnoume ta katallila stoixeia */
	if( type == 1 )
	{
		if( zone == 'A' )
		{
